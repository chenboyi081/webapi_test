...
namespace 算法测试2015_09_24
{
    ...
    {
        #region FormsAuthentication.HashPasswordForStoringInConfigFile 方法 + SHA1加密
        /// <summary>
        /// 使用SHA1/MD5算法
        /// FormsAuthentication.HashPasswordForStoringInConfigFile 方法 参考：https://msdn.microsoft.com/zh-cn/library/system.web.security.formsauthentication.hashpasswordforstoringinconfigfile(v=vs.100).aspx
        /// 命名空间：System.Web.Security
        /// 备注：使用该方法，会报“该方法已过时”的警告
        /// </summary>
        public string EncryptByHashPasswordForStoringInConfigFileMethod(string tmpStr, string encryptMethod)
        {
            string Str = FormsAuthentication.HashPasswordForStoringInConfigFile(tmpStr, encryptMethod);
            return Str;
        }
        #endregion

        #region RSA相关加密 + link：http://blog.csdn.net/llwinnner/article/details/4011936
        /// <summary>
        /// 生成公私钥
        /// </summary>
